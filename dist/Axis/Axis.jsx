...
export class Axis extends Component {
    ...
    render({ height, axisType, grid, offsetX }) {
        ...
        return (<g>
                <g ref={(axis) => this.axis = axis} class={`${style.axis}`} transform={shouldOffset ? translate : ''}>
                </g>
                {grid &&
            <g ref={(gridline) => this.grid = gridline} class={`${style.grid}`} transform={shouldOffset ? translate : ''}>
                    </g>}
            </g>);
    }
}
